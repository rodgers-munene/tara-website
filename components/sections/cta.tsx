  ...
  return (
    <section id="get-started" className="relative overflow-hidden bg-emerald-700 px-6 py-24 text-cream md:px-12 md:py-32">
      ...
      <Reveal className="relative mx-auto max-w-3xl text-center">
        ...
        <div className="mt-9 flex justify-center"><Button href={siteConfig.ownerPortalUrl} variant="inverted" className="group rounded-full px-6 py-3.5">Get started with Tara <ArrowRight className="size-4 transition-transform duration-300 group-hover:translate-x-1" /></Button></div>
